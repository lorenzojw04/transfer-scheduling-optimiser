...
I have just successfully built the python proof of concepts which takes a test environment and produces all chains for each snake! Perfect. Now I will pivot onto implementing it in Java
